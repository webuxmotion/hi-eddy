<ol>
  ...
  <li>
    ...
    <p>
      Папку можна створити і на робочому столі. Для цього
      клацніть правою кнопкою мищі на робочому столі та виберіть
  ...
  <li>
    ...
    <p>
      ...
      в провідніку файлів, потім натисніть по ньому правою кнопкою мищі
